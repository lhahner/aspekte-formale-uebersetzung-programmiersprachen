...
\begin{lstlisting}[language=PL/I, caption=PL/I-Primzahlen Programm]
PACKBA: PACKAGE;
	DCL Z DECIMAL(5);
	DCL MESSAGE CHAR(5);
...
\end{lstlisting}
\pagebreak
\begin{lstlisting}[language=Java, caption=Übersetzes Java-Primzahlen Programm]
...
\end{lstlisting}
\pagebreak
	\begin{lstlisting}[language=Java, caption=Angepasstes Java-Primzahlen Programm]
	public class TranspiledExamplePliProgram implements IProgram {
