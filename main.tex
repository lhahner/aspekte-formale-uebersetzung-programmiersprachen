...
\dhgefigure[h]{AbstraktesUML_1.png}[scale=0.5]{Der Aufbau des Transpilers}{fig:modules}[][]
...
\dhgefigure[h]{parsetree-example.drawio.png}[scale=0.5]{Beispielhafter Syntaxbaum des PL/I-Parsers}{fig:parsetree}[][]
...
\dhgefigure[h]{symboltable-module-uml.drawio.png}[scale=0.5]{Symboltabellen-Modul}{fig:symboltable}
\pagebreak
...
\dhgefigure[h]{parsetree-example-searchalgo.png}[scale=0.5]{Beispielhafte Iteration des Syntaxbaums}{fig:parsetreealgo}[][]
\pagebreak
