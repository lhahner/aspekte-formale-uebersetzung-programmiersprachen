...
Denn der Erfahrene Java-Entwickler wird mit den Standard-Java Exception vertraut sein 
und entsprechend schneller die Fehler behandeln. In der Tabelle \ref{tab:exceptiontabelle} sind die verwendeten Exception dargestellt.

\begin{tabular}[h]{lcr}
	\caption{Exceptions des Transpilers }
	Exception & Quelle & Kurzbeschreibung \\
	\verb+IncorretInputFileException+ & Errorhandling-Modul & Wird bei der Eingabe eines Dateityps, anders als .pli geworfen. \\
	\verb+LexicalErrorException+ & Errorhandling-Modul & Wird aufgrund eines Lexikalischen Fehlers im Picture-Ausdruck geworfen.\\
	\verb+TypeMappingException+ & Errorhandling-Modul & Wird beim transformieren von unbekannten PL/I-Datentypen geworfen.\\
	\verb+ParseException+ & Parser-Modul & Wird beim Parsen des PL/I-Quellcodes geworfen.\\
	\verb+MappingException+ & Errorhandling-Modul & Wird geworfen wenn Werte beim Mappen des Syntaxbaums fehlen.\\
	\verb+IOExcpetion+ & Java-IO-Package & Fehlerhafte Dateieingabe im Scanner-Modul \\
	\verb+NumberFormateExcpetion+ & Java-Lang-Package & Typfehler beim zuweisen von eines Numerischen-Datentyps. \\
	\verb+IllegalArgumentException+ & Java-Lang-Package & Typfehler beim zuweisen von eines Alphanumerischen-Datentyps. \\
	\verb+NullPointerException+ & Java-Lang-Package & Fehlerhafte Datenstruktur, wie etwa Symboltabelle oder Syntaxbaum \\
	\verb+DuplicateRequestException+ & Jdi-Request-Package & Wenn ein Wert in die Symboltabelle eingefügt werden soll, der schon vorhanden ist.\\
	\label{tab:exceptiontabelle}
\end{tabular}

Mithilfe der \verb+MappingException+ etwa wird vor jeder Terminierung der \verb+translate+ Methode des Mapper-Moduls überprüft ob 
...
Der Benutzer wird durch die \verb+ParseException+ darauf hingewiesen wo ein Fehlerauftritt
und welche Schritte unternommen werden müssen um den Fehler zu beheben.
...
Es wurde sich, aufgrund der beschränkten Arbeitszeit, auf die wesentlichen Strukturelemente 
einer Programmiersprache entschieden.
Dazu zählen Deklarationen, Kontrollflussanweisungen und Ein- und Ausgabeströme.
