...
% Beispiel mit Go-to Tabelle usw
...
Hierbei bleibt die Länge des Eingabe-Quellcodes unberücksichtigt, somit könnte ein unendlich langes Programm von einem Parser so lange
